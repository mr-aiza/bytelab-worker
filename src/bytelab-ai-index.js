...
// تحلیل تصویر (vision) چندین برابر چت متنی نورون مصرف می‌کنه (هر درخواست می‌تونه تا ~۱۳۰۰+ نورون بخوره)، پس سقف خیلی سخت‌گیرانه‌تری داره
const VISION_RATE_LIMIT_PER_IP_PER_DAY = 2;
